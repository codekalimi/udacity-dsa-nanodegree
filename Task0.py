...
# Big O Notation
# The time complexity of this function is O(1) because the function only prints the first and last record of the texts and calls list. The time complexity is constant.